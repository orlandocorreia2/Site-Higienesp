...
(function (e, t) {
  ...
  function f(e, n) {
    ...
    if (n.navigationArrows != "none" && n.navigationArrows != "nexttobullets")
      o = n.soloArrowStyle;
    e.parent().append(
      '<div style="' + s + '" class="tp-leftarrow tparrows ' + o + '"></div>'
    );
    e.parent().append(
      '<div style="' + s + '" class="tp-rightarrow tparrows ' + o + '"></div>'
    );
    e.parent()
      .find(".tp-rightarrow")
      .click(function () {
  ...
  function w(n, r) {
    ...
    else if (u.data("transition") == "cubic" || u.data("transition") == "cube")
      l = 19;
    ...
    if (l == 12 || l == 13 || l == 14 || l == 15) {
      ...
      if (l == 12)
        ...
        if (r.ie9) w.transition({ left: 0 - r.width + "px" }, 0);
        else w.transition({ left: 0 - r.width + "px", rotate: r.rotate }, 0);
      else if (l == 13)
        if (r.ie9) w.transition({ top: b + "px" }, 0);
        else w.transition({ top: b + "px", rotate: r.rotate }, 0);
      else if (l == 14)
        if (r.ie9) w.transition({ top: 0 - r.height + "px" }, 0);
        else w.transition({ top: 0 - r.height + "px", rotate: r.rotate }, 0);
      w.transition(
    ...
    if (l == 16) {
      ...
      if (!e.support.transition) {
        ...
        if (i.html() != null)
          u.transition(
            { scale: 0.8, x: r.width * 0.1, y: r.height * 0.1, rotate: N },
            0
    ...
    if (l == 20) {
      ...
      a.find(".slotslide").each(function (t) {
        var n = e(this);
        n.transition(
          { scale: 0.5, left: 0, perspective: 500, rotate3d: "1, 5, 0, 5deg" },
          300,
          "in-out"
        );
        a.find(".defaultimg").css({ opacity: 0 });
              ...
              if (!n.hasClass("HasListener")) {
                try {
                  ...
                  if (u.data("autoplay") == true)
                    r = new YT.Player(l, {
                      events: { onStateChange: S, onReady: x },
                    });
                  else r = new YT.Player(l, { events: { onStateChange: S } });
        ...
        if (u.data("end") != t)
          u.data(
            ...
            setTimeout(function () {
              if (
                (r.ie || r.ie9) &&
                (u.hasClass("randomrotate") || u.hasClass("randomrotateout"))
              ) {
                u.removeClass("randomrotate")
        ...
        if (!o.hasClass("revslider-initialised")) {
          ...
          if (i.shuffle == "on") {
            for (var m = 0; m < o.find(">ul:first-child >li").length; m++) {
              ...
              o.find(">ul:first-child >li:eq(" + g + ")").prependTo(
                o.find(">ul:first-child")
              );
            }
          }
          i.slots = 4;
