 ...
 */ window.selectnav = (function () {
  ...
  var a = function (a, b) {
    ...
    function o(a) {
      ...
      for (var p = 0; p < b; p++) {
        ...
        d &&
          (s =
            ...
            q.parentElement.className.search(d) !== -1
              ? j
              : ""),
          e && !s && (s = q.href === document.URL ? j : ""),
          (c +=
            '<option value="' + q.href + '" ' + s + ">" + k + r + "</option>");
        if (f) {
      ...
      return (
        i === 1 && h && (c = '<option value="">' + h + "</option>" + c),
        i === 1 &&
          (c =
            '<select class="selectnav" id="' + n(!0) + '">' + c + "</select>"),
        i--,
        c
      );
    }
    ...
    var c = b || {},
      ...
      e = typeof c.autoselect == "boolean" ? c.autoselect : !0,
    ...
    return (
      k.addEventListener && k.addEventListener("change", l),
